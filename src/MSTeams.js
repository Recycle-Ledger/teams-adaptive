            ...
            attachments: [
                {
                    ...
                    content: {
                        ...
                        body: [
                            {
                                type: "TextBlock",
                                text: `${sender.login} ${eventName} initialised workflow "${workflow}"`,
                                weight: "bolder",
                                size: "medium",
                                wrap: "true"
                            },
                                        ...
                                        columns: [
                                            {
                                                ...
                                                items: [
                                                    {
                                                        type: "Image",
                                                        url: status_summary.activityImage,
                                                        size: "medium",
                                                        style: "person"
                                                    }
                                                ]
                                            },
                                            {
                                                ...
                                                items: [
                                                    {
                                                        type: "TextBlock",
                                                        text: status_summary.activityTitle,
                                                        weight: "bolder",
                                                        wrap: "true"
                                                    },
                                                    {
                                                        type: "TextBlock",
                                                        spacing: "none",
                                                        text: `Created ${status_summary.activitySubtitle}`,
                                                        wrap: "true"
                                                    }
                                                ]
                                            }
